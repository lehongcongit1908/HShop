...
<form:form action="${url}/index" modelAttribute="form"
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<b>PRODUCT EDITION</b> <i class="text-danger pull-right">${message}</i>
			<h2>${date}</h2>
		</div>
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group col-sm-6 text-center">
						<label for="image_file"> <img
							src="/static/images/items/${form.image}"
							style="height: 200px; max-width: 95%">
						</label> <input id="image_file" name="image_file" type="file"
							class="form-control">
				...
				<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<form:input path="discount" type="number" placeholder="Discount?"
							class="form-control" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-6">
					...
					<form:input path="quantity" type="number" placeholder="Quantity?"
						class="form-control" />
				</div>
				<div class="form-group col-sm-6">
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					...
					<form:input path="clickCount" type="number"
						placeholder="View Count?" class="form-control" />
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-6">
		...
		<div class="panel-footer text-right">
			...
			<a href="${url}/delete/${form.id}" ${empty form.id ? 'disabled' : ''}
				...
				Delete
			</a> <a href="${url}/index" class="btn btn-info"> <i
